...
class TheHopeTicketService:
    ...
    async def get_ticket_types(self, *, _span: Span = None) -> dict:
        """
    ...
    @distributed_trace(inject_span=True)
    async def get_ticket_by_id(self, ticket_id: UUID, *, _span: Span = None) -> Optional[dict]:
        """
        Get ticket by id.
        :param ticket_id:
        :param _span:
    ...
    @distributed_trace(inject_span=True)
    async def get_ticket_list_by_email(self, user_email: str, *, _span: Span = None) -> Optional[dict]:
        """
    ...
    @distributed_trace(inject_span=True)
    async def check_in_ticket(self, ticket_id: UUID, *, _span: Span = None) -> dict:
        """
